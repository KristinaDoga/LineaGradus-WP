...
if ( ! function_exists( 'woostify_logged_in_menu' ) ) {
	...
	function woostify_logged_in_menu() {
		...
		if ( ! is_user_logged_in() ) {
			...
			$dasboard = '<a href="' . get_permalink( $page_account_id ) . '">' . esc_html__( 'Панель управления', 'woostify' ) . '</a>';
			?>
			...
			<li class="my-account-logout">
				<a href="<?php echo esc_url( $logout_url ); ?>"><?php esc_html_e( 'Выход', 'woostify' ); ?></a>
			</li>
			<?php
...
// echo '<button class="callback__popup">Обратный звонок</button>';
		...
		<div class="site-dialog-search  woostify-search-wrap">
			<div class="dialog-search-content">
				...
				<div class="dialog-search-header">
					<span class="dialog-search-title"><?php esc_html_e( 'Начнём поиск', 'woostify' ); ?></span>
...
document.addEventListener( 'wpcf7submit', function( event ) {
         ...
         document.getElementById('wpcf7-f215-p87-o1').style.display = 'none';
